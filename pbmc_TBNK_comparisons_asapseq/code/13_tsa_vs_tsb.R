...
TSA1 =  adt_mat_CLR[grepl("LLL", rownames(adt_mat_CLR)),1:9]
TSB1 =  adt_mat_CLR[grepl("LLL", rownames(adt_mat_CLR)),10:18]
TSA2 =  adt_mat_CLR[grepl("OMNI", rownames(adt_mat_CLR)),1:9]
TSB2 = adt_mat_CLR[grepl("OMNI", rownames(adt_mat_CLR)),10:18]
...
atac1 = read.csv("../data/AvsB/singlecell_OMNI.csv.gz")
atac2 = read.csv("../data/AvsB/singlecell_LLL.csv.gz")
