...
# Import counts 
asap_control <- import_kite_counts("../../pbmc_stimulation_asapseq/data/adt/ASAP_ctrl_ADT/",  Ac_bcs, "ASAP", "noStim")
asap_stim <- import_kite_counts("../../pbmc_stimulation_asapseq/data/adt/ASAP_stim_ADT/",  As_bcs,"ASAP", "Stim")
cite_control <- import_kite_counts("../../pbmc_stimulation_citeseq/data/adt/ctrl_featurecounts/",  Cc_bcs,"CITE", "noStim")
cite_stim <- import_kite_counts("../../pbmc_stimulation_citeseq/data/adt/stim_featurecounts/", Cs_bcs,"CITE", "Stim")
